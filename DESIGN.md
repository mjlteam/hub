...
- **Primary Canvas:** True white (`#ffffff`) for a clean, clinical backdrop.
...
- **Primary Sans:** Söhne (or system fallback *Inter*) at restrained weights:
  - `400` for Body
  - `500` for Navigation & Labels
  - `600` for Emphasis
- **Editorial Serif:** Signifier for contemporary display and headings.
